...
class THMPicTransform
{
	...
	public function __construct($picFile)
	{
		...
		switch ($imgSize[2])
		{
			...
			case 3:
				$this->_type = "PNG";
				break;
			default: throw new Exception("Unpassender Typ");
				break;
		}
	}
	...
	public function getExtension()
	{
		switch ($this->getType())
		{
			...
			case 'PNG': return ".png";
				break;
			default: throw new Exception("Nicht unterstuetztes Format");
				break;
		}
	}
	...
	public function safeSpecial($dest, $filename, $maxWidth, $maxHeight, $type="PNG")
	{
		switch ($this->getType())
		{
			...
			case 'PNG':
				$image = imagecreatefrompng($this->getPath());
				break;
			default: throw new Exception("Falscher Typ");
				break;
		}
	...
	private function safeImage($image, $dest, $filename, $type="PNG")
	{
		switch ($type)
		{
			...
			return $filename . '.png';
				break;
			default: throw new Exception("Illegaler Typ");
				break;
		}
	}
