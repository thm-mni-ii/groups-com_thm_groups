 ...
 * @name        THMGroupsControllerQp_Alias
 * @description THMGroupsControllerQp_Alias class from com_thm_groups
 ...
 */
class THMGroupsControllerQp_Alias extends JControllerLegacy
{
    /**
