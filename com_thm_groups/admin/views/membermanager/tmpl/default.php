                            ...
                            if ($groupname == $grouprole->groupname)
                            {
                                 ...
                                 && $user->authorise('core.manage', 'com_users'))
                                {
                                     ...
                                     && JAccess::check($row->userid, 'core.admin')))
                                    {
                                        ...
                                        . ".' class='hasTip'><img src='components/com_thm_groups/assets/images/icon-32-removeassignment.png' width='16px'/></a> ";
                                    }
                                }
                            }
                            else
                                    ...
                                    if ($countRoles > 1)
                                    {
                                         ...
                                         && $user->authorise('core.manage', 'com_users'))
                                        {
                                             ...
                                             && JAccess::check($row->userid, 'core.admin')))
                                            {
                                                ...
                                                <img src='components/com_thm_groups/assets/images/icon-32-removeassignment.png' width='16px'/></a> ";
                                            }
                                        }
                                    }
                                    else
