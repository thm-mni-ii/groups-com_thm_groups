		...
		if ($extra != "")
		{
			...
			$k = 0;
				foreach ($arrValue as $key => $row)
				{
					...
					$output .= "<td><a href='javascript:delTableRow($key, $structid );' title='Zeile: " . ($key + 1) . "::Zeile entfernen.' "
					...
					. "title='Zeile: " . ($key + 1) . "::Zeile bearbeiten.' class='modal-button hasTip' rel=\"{handler: 'iframe', "
