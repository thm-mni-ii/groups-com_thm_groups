		...
		<div class="span3">
			<div class="form-inline" role="form">
				...
				<div class="form-group">
					...
					<img
						src="<?php echo JURI::root() . "administrator/components/com_thm_groups/assets/images/green_add_plus.png"; ?>"
						class="img-responsive img-circle" width="30" style="cursor:pointer" alt="add"
						onclick="putSelectAttributeInTable()">
				</div>
		...
		<div class="span3">
			<table id="attributeTable" class="table table-striped" style="position: relative;">
				...
				<tr>
					...
					<th><?php echo JText::_('COM_THM_GROUPS_PROFILE_ATTRIBUTE_NAME'); ?></th>
				...
				<?php foreach ($allatributeofprofilJson as $index => $attrParams)
				{
					...
					<tr id="trattr_<?php echo $index; ?>">
						...
						<td id="name"><?php echo $attrParams->name; ?></td>
						<td id="labeltd">
						...
						<td style='cursor:pointer' onclick="deleteAttr(<?php echo $index; ?>)">
							<img
								src="<?php echo JURI::root() . "administrator/components/com_thm_groups/assets/images/trash.png"; ?>"
								width=15 height=10 alt='X'/></td>
					</tr>
				<?php } ?>
				</tbody>
			</table>
