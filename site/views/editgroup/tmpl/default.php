		...
		<fieldset class="adminform">
			...
			<table class="admintable">
				...
				<tr>
					...
					<td>
						<input type='submit' id="gs_editView_buttons" onclick='return confirm("Wirklich zurück?"), document.forms["adminForm"].elements["task"].value = "editgroup.backToRefUrl"' value='Zurück' name='backToRefUrl' task='editgroup.backToRefUrl' />
					</td>
				</tr>
			</table>
