...
<?php
	...
	foreach($members as $id => $member) {
		...
		echo $title . " <a href=".JRoute::_('index.php?option=com_thm_groups&view=advanced&layout=list&Itemid='.$this->itemid.'&gsuid='.$id.'&name='.trim($lastName).'&gsgid='.$this->gsgid).">". trim($firstName) . " " . trim($lastName) . "</a>";
