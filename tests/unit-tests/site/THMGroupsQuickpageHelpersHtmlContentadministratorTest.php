...
class HelpersHrmlContentadministratorTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$result_1 = JHtmlContentAdministrator::featured(self::ENTRY_ID);

		$result_2 = "<a href=\"javascript:void(0);\" onclick=\"return listItemTask('cb99999','articles.featured')\"" .
			" title=\"COM_CONTENT_TOGGLE_TO_FEATURE\"><img src=\"\" alt=\"COM_CONTENT_UNFEATURED\"  /></a>";
